...
class _HomePageState extends State<HomePage> {
  ...
  final List<Color> colors = <Color>[Colors.red, Colors.blue,Colors.amber,Colors.orangeAccent, Colors.cyan,Colors.tealAccent,Colors.teal, Colors.deepPurple,Colors.yellowAccent];
                  ...
                  return GestureDetector(
                    ...
                    child: Container(
                      decoration: BoxDecoration(
                        border: Border.all(
                          color: Color(0xFFb5a396),
                        ),
                      ),
                      child: Center(
                        child: Text(
                          displayExOh[index],
                          style: TextStyle(color:colors[index], fontSize: 40),
                        ),
                      ),
                    ),
                  );
            ...
            child: Center(
              child: Column(
                children: [
                  ...
                  SizedBox(height: 60),
                  Text("@World-Package", style: myNewFontWhite),
                ],
              ),
            ),
          )),
